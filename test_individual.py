...
def test_get_individual_data_first_gen(individual_first_gen):
    assert np.shape(individual_first_gen.data) == (10, 10)

def test_get_individual_data_from_parents(individual_any_gen):
    assert np.shape(individual_any_gen.data) == (10, 10)
