...
class Generation:
    ...
    def __init__(self, gen_num, number_of_individuals, loss_type, original_image, gene_transfer_method,
                 ratio_of_individuals_for_next_gen, prev_gen_ind_list, mut_rate):
    ...
    def create_individual(self, prev_gen_ind_list):
        ...
        specimen = Individual(size_x, size_y, image_type, self.gene_transfer_method, self.loss_type, self.mut_rate,
                              parent1, parent2)
    ...
    # TODO: All generation statistics should be done in their own class
